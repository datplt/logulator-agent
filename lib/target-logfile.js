...
var debuglog = debug('logulator:agent:target:logfile');

function TargetLogfile(params) {
  var self = this;
...
util.inherits(TargetLogfile, events.EventEmitter);

module.exports = TargetLogfile;
